...
struct scheduler {
	 ...
	 *   in the ready status. When the current is blocked (i.e., waiting for
	 *   some resources), however, you should not put it back into the ready
	 *   queue since it is not ready but is waiting for the resource!!
	 *
	 * RETURN
	 *   process to run next
